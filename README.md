...
This repository provides a reproducible toy example illustrating the methodology proposed in the paper: **"Scalable Multitask Gaussian Processes for Complex Mechanical Systems with Functional Covariates"**, *Razak C. Sabi Gninkou, Andrés F. López-Lopera, Franck Massa, Rodolphe Le Riche*  .
